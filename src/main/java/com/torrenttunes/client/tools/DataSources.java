...
public class DataSources {
    ...
    public static final String TORRENTS_DIR() {
        return HOME_DIR() + "/torrents";
    }

    public static final String DEFAULT_MUSIC_STORAGE_PATH() {
        return HOME_DIR() + "/music";
    }

    public static String MUSIC_STORAGE_PATH = DEFAULT_MUSIC_STORAGE_PATH();

    public static final String AUDIO_FILE(String fileName) {
        return MUSIC_STORAGE_PATH + "/" + fileName;
    }

    public static final String SAMPLE_TORRENT_FILE() {
        return TORRENTS_DIR() +
    ...
    public static final String SOURCE_CODE_HOME() {
        return HOME_DIR() + "/src";
    }
    ...
    public static final String SQL_VIEWS_FILE() {
    ...
    public static final String TOOLS_JS() {
    ...
    public static final String WEB_HTML() {
        return WEB_HOME() + "/html";
    }

    public static final String WEB_SERVICE_STARTED_URL() {
        return WEB_SERVICE_URL + "hello";
    }

    public static final String MAIN_PAGE_URL_EN() {
        return WEB_HTML() + "/main_en.html";
    }

    public static final String MAIN_PAGE_URL_ES() {
        return WEB_HTML() + "/main_es.html";
    }

    public static final String MAIN_PAGE_URL_FR() {
        return WEB_HTML() + "/main_fr.html";
    }


    public static final String MAINTENANCE_PAGE_URL() {
        return WEB_HTML() + "/maintenance.html";
    }
    ...
    public static final String SESSION_STATS_FILE() {
...
//					new URI("udp://tracker.openbittorrent.com:80/announce"));
    ...
    public static String TEMP_JAR_PATH() {
        return System.getProperty("user.home") + "/" + APP_NAME + ".jar";
    }
    ...
    public static final String STRINGS_EN_LOCATION() {
        return SOURCE_CODE_HOME() + "/values/strings_en.json";
    }

    public static final String STRINGS_ES_LOCATION() {
        return SOURCE_CODE_HOME() + "/values/strings_es.json";
    }

    public static final String STRINGS_FR_LOCATION() {
